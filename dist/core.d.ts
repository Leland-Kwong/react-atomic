...
export declare function createAtom<T>({ key, defaultState, resetOnInactive }: Atom<T>): Atom<T>;
declare type IsEqualFn<T> = (prev: T, next: T) => boolean;
export declare function useRead<T, SelectorValue = T>(atom: Atom<T>, selector: SelectorFn<T, SelectorValue>, isEqualFn?: IsEqualFn<SelectorValue>): SelectorValue;
